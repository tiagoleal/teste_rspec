...
VCR.configure do |config|
  ...
  #oculta o endereço https e troca por API-URL
...
Capybara.default_max_wait_time = 5 #tem de retorno ao executar alguma interação com a view (inclusive no Ajax)
...
RSpec.configure do |config|
  ...
  #configurado par rodar de forma automatica
  # docker-compose run --rm app bundle exec rspec --seed + 19070(number do random)
  config.order = "random"
